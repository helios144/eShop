	        	...
	        	<div class="menuextras">
		         ...
		         <nav id="mainmenu" class="mainmenu">
					<ul>
						...
						<li>
							<a href="Admin_tools_redaguoti.php">Features</a>
						</li>
								...
								<div class="mainmenu-submenu-inner"> 
									...
									<div>
										...
										<ul>
											...
											<li><a href="products.html">Products listing (4 Columns)</a></li>
					...
					<div class="col-sm-5">
						<div class="basic-login">
							<form role="form" method="post" action="">
								...
								<div class="form-group">
									<button type="submit" name="submitreg" class="btn pull-right">Register</button>
